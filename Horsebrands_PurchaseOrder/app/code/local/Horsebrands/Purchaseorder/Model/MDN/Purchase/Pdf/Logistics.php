...
class Horsebrands_Purchaseorder_Model_MDN_Purchase_Pdf_Logistics extends MDN_Purchase_Model_Pdf_Order {
  ...
  public function getPdf($orders = array()) {
   ...
   public function drawTableHeader(&$page) {
       ...
       $page->drawText(mage::helper('purchase')->__('Lastname'), 100, $this->y, 'UTF-8');
       $page->drawText(mage::helper('purchase')->__('Sku'), 185, $this->y, 'UTF-8');
       $page->drawText(mage::helper('purchase')->__('Sku Supplier'), 280, $this->y, 'UTF-8');
       $page->drawText(mage::helper('purchase')->__('Product Name'), 370, $this->y, 'UTF-8');
       $page->drawText(mage::helper('purchase')->__('Qty'), 600, $this->y, 'UTF-8');
